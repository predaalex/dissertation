...
In this project, I explore whether facial emotion recognition can be useful in the interaction between humans and AI assistants, not only as a standalone image classification task.
...
The main challenge of this project is to integrate several AI components into one local architecture that can run on a regular user's device: webcam-based emotion recognition, speech-to-text, LLM response generation, session management, and real-time response streaming.
